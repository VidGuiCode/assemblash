...
**Current release: 1.2.0.** The document schema and operation API have been
stable since 1.0. See the [release notes](https://github.com/VidGuiCode/assemblash/releases/tag/v1.2.0)
...
unpack it, and launch `assemblash` (`assemblash.exe` on Windows).
...
```sh
cargo install --git https://github.com/VidGuiCode/assemblash --tag v1.2.0 assemblash-cli
```
