...
**Current release: 1.7.1.** The document schema and operation API have been
stable since 1.0. See the [release notes](https://github.com/VidGuiCode/assemblash/releases/tag/v1.7.1)
